 ...
 * @subpackage Wp_Plugin_Boilerplate/public
 */
 ...
 * @package    Wp_Plugin_Boilerplate
 * @subpackage Wp_Plugin_Boilerplate/public
 * @author     Vishnu Y <vishnu.y@outlook.com>
 */
class Wp_Plugin_Boilerplate_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/wp-plugin-boilerplate-public.js', array( 'jquery' ), $this->version, false );
